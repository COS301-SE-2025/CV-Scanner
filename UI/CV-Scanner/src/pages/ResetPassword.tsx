  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        console.error("Reset request failed:", res.status, body);
        alert(
          (body && (body.message || body.error)) || "Failed to send reset link"
        );
      }
    } catch (err) {
      console.error("Network error on reset request:", err);
